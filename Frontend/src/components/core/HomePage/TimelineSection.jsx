...
const timeline = [
  ...
  },
  {
    ...
    Description: "Code your way to asolution",
  },
];
    ...
    <div>
      <div className="flex flex-row gap-15 items-center">
        ...
        <div className="relative shadow-blue-200">
          ...
          {/*Left green part */}
          <div className="absolute bg-caribbeangreen-700 flex flex-row text-white uppercase py-7 left-[50%] translate-x-[-50%] translate-y-[-50%] px-6">
